...
f0=open('scandata0_diff.csv', 'w', newline="")
f1=open('scandata1_diff.csv', 'w', newline="")
f2=open('scandata2_diff_track.csv', 'w', newline="")
f3=open('scandata1_diff_trackall.csv', 'w', newline="")
f4=open('scandata3_diff_time.csv', 'w', newline="")
